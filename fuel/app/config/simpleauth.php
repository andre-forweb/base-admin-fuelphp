...
return array(
	...
	'groups' => array(
        ...
        10  => array('name' => 'Administrator', 'roles' => array('user', 'admin'))
	),
	...
	'roles' => array(
        ...
        'banned' => FALSE,
        'user' => array(
            'contratacao' => array('create', 'read', 'update', 'delete'),
            'promocao' => array('create', 'read', 'update', 'delete'),
            'usuarios' => array('read'),
        ),
        'admin' => TRUE
	),
